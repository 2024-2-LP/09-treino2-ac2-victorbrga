...
public class RemoverLivroPorTituloInexistenteProvider implements ArgumentsProvider {
    ...
    public Stream<? extends Arguments> provideArguments(ExtensionContext extensionContext) throws Exception {
        ...
        return Stream.of(
                Arguments.arguments(list, "Restaurante no Fim do Universo", list),
                Arguments.arguments(list, "Guia do Mochileiro das Galáxias", list),
                Arguments.arguments(list, "Até Mais, e Obrigado Pelos Peixes", list),
                Arguments.arguments(list, "Praticamente Inofensiva", list),
                Arguments.arguments(list, "Java: Como Programar", list)
        );
