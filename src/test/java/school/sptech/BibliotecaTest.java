...
import school.sptech.providers.biblioteca.BuscarLivroPorTituloInvalidoProvider;
import school.sptech.providers.biblioteca.BuscarLivroPorTituloNaoExistenteProvider;
...
import school.sptech.providers.biblioteca.RemoverLivroPorTituloInexistenteProvider;
import school.sptech.providers.biblioteca.RemoverLivroPorTituloInvalidoProvider;
...
public class BibliotecaTest {
    ...
    class ValidarMetodoAdicionarLivro {
        ...
        void test2(String nome, List<Livro> livros, Livro livro, List<?> expected) throws ReflectiveOperationException {
            ...
            InvocationTargetException exception = assertThrows(
                    InvocationTargetException.class, () -> method.invoke(obj, livro));

            assertTrue(exception.getCause() instanceof ArgumentoInvalidoException);
        }
    }
    ...
    class RemoverLivro {
        ...
        @ParameterizedTest
        @DisplayName("1. Remover livro por título")
        ...
        @DisplayName("2. Remover livro por título ignorando case")
        @ParameterizedTest
        ...
        @DisplayName("3. Remover livro por título inválido")
        @ParameterizedTest
        @ArgumentsSource(RemoverLivroPorTituloInvalidoProvider.class)
        void validarRemoverLivroPorTituloInvalidos(
                List<Livro> livrosAll,
                String titulo,
                List<Livro> livrosFilters
        ) throws ReflectiveOperationException {
            ...
            InvocationTargetException exception = assertThrows(
                    InvocationTargetException.class, () -> method.invoke(obj, titulo));

            assertTrue(exception.getCause() instanceof ArgumentoInvalidoException);
        }

        @DisplayName("4. Remover livro por título inexistente")
        @ParameterizedTest
        @ArgumentsSource(RemoverLivroPorTituloInexistenteProvider.class)
        void validarRemoverLivroPorTituloInexistente(
                List<Livro> livrosAll,
                String titulo,
                List<Livro> livrosFilters
        ) throws ReflectiveOperationException {
            ...
            assertTrue(exception.getCause() instanceof LivroNaoEncontradoException);
        }
    }
    ...
    class RemoverLivroPorTitulo {
        ...
        @DisplayName("1. Buscar livro que existe por título")
        void test1(List<Livro> livrosAll, String titulo, Livro expected) throws ReflectiveOperationException {
        ...
        @ParameterizedTest
        @ArgumentsSource(BuscarLivroPorTituloNaoExistenteProvider.class)
        @DisplayName("2. Buscar livro que não existe por título")
        void test2(List<Livro> livrosAll, String titulo, Livro expected) throws ReflectiveOperationException {
        ...
        @ParameterizedTest
        @ArgumentsSource(BuscarLivroPorTituloInvalidoProvider.class)
        @DisplayName("3. Buscar livro por título inválido")
        void test3(List<Livro> livrosAll, String titulo, Livro expected) throws ReflectiveOperationException {
    ...
    class ContarLivros {
        ...
        void validarContarLivros(List<Livro> livros, Integer expected) throws ReflectiveOperationException {
            Class<Biblioteca> clazz = Biblioteca.class;
